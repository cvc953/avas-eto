              ...
              : ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return Card(
                    ...
                    child: ExpansionTile(
                      key: PageStorageKey(tarea.title),
                      initiallyExpanded: _tareaExpandidaKey == claveCorrecta,
                      onExpansionChanged: (expanded) {
                        setState(() {
                          _tareaExpandidaKey = expanded ? claveCorrecta : null;
                        });
                      },
                      title: Text(tarea.title),
                      trailing: Icon(
                        _tareaExpandidaKey == claveCorrecta
                            ? Icons.expand_less
                            : Icons.expand_more,
                      ),
                      leading: CircleAvatar(
